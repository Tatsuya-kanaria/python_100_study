...
# 2016 〜　2020
tmp = tmp.loc[(tmp['update_fiscal_year'] >= 2016) &
              (tmp['update_fiscal_year'] < 2021)]
...
# hue:判例　lineplot:折線グラフ
img = sns.lineplot(x=tmp['update_fiscal_year'],
                   y=tmp['count'], hue=tmp['cityName'])
